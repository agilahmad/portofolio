        ...
        <div className="about-outer">
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: ".6rem" }}>
            <div className="photo-frame" style={{ width: "100%", maxWidth: 280, height: 370 }}>
              <Image src="/foto-about.jpeg" alt="Agil Ahmad Maulana" fill style={{ objectFit: "cover", objectPosition: "center top" }} />
              <div className="photo-color-reveal">
                <Image src="/foto-about.jpeg" alt="" fill style={{ objectFit: "cover", objectPosition: "center top" }} aria-hidden />
              </div>
